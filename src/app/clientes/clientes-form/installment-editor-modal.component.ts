...
@Component({
  ...
  templateUrl: './installment-editor-modal.component.html',
  styleUrls: ['./installment-editor-modal.component.css']
})
export class InstallmentEditorModalComponent implements OnInit {
